...
all: SINGLEGROUP_allOn SINGLEGROUP_hcOn SINGLEGROUP_pdOn SINGLEGROUP_pdOff

clustcorr: SINGLEGROUP_allOn_clustcorr SINGLEGROUP_hcOn_clustcorr SINGLEGROUP_pdOn_clustcorr SINGLEGROUP_pdOff_clustcorr
